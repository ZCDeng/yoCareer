...
- [ ] `docs/solutions/` 首批 compound learnings 沉淀（URL allowlist hostname 校验、structured YAML lookup as LLM tie-breaker、ATS pdftotext round-trip selftest、CJK LaTeX xeCJK 字体栈、CI skip-on-missing-tool 模式）
- [ ] 浏览器扩展商店上架（Edge Add-ons / 极简插件商店 / Crx搜搜）
