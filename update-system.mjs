...
/**
 * update-system.mjs — Safe auto-updater for yoCareer
 *
...
const CANONICAL_REPO = 'https://github.com/ZCDeng/yoCareer.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/ZCDeng/yoCareer/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/ZCDeng/yoCareer/releases/latest';
    ...
    [versionResult, releaseResult] = await Promise.allSettled([
      ...
      fetch(RELEASES_API, {
        headers: {
          ...
          'User-Agent': 'yoCareer-update-checker',
        },
