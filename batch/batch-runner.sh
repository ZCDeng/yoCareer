...
# yoCareer batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
yoCareer batch runner — process job offers in batch via claude -p workers
