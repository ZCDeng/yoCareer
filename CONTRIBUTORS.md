...
yoCareer exists because of the people who build with it. thank you.
...
- **[@piscespieces](https://github.com/piscespieces)** (Andres Urdaneta) — Docs architect. Maintains the getting-started guides at [yoCareer-docs.vercel.app](https://yoCareer-docs.vercel.app). Shipped [PR #286](https://github.com/ZCDeng/yoCareer/pull/286) (portals cleanup). Authored the comparative analysis that defines what yoCareer is vs. isn't.

## Shipping with the project

- **[@CURT1S03](https://github.com/CURT1S03)** (Curtis) — LaTeX/Overleaf CV export ([PR #362](https://github.com/ZCDeng/yoCareer/pull/362), merged — resolves [#47](https://github.com/ZCDeng/yoCareer/issues/47))
- **[@vivek-gite](https://github.com/vivek-gite)** — A16Z provider support ([PR #271](https://github.com/ZCDeng/yoCareer/pull/271), in review)
