...
import (
	...
	"github.com/ZCDeng/yoCareer/dashboard/internal/data"
	"github.com/ZCDeng/yoCareer/dashboard/internal/model"
	"github.com/ZCDeng/yoCareer/dashboard/internal/theme"
	"github.com/ZCDeng/yoCareer/dashboard/internal/ui/screens"
)
...
func main() {
	pathFlag := flag.String("path", ".", "Path to yoCareer directory")
	flag.Parse()
