...
Processa URLs de vagas acumuladas em `data/pipeline.md`. O candidato adiciona URLs quando quiser e depois executa `/yoCareer pipeline` para processar todas de uma vez.
