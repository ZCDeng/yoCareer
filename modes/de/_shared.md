# Geteilter Kontext -- yoCareer (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle yoCareer-Modi
     in der deutschen Variante. Bevor du yoCareer verwendest, MUSST du:
