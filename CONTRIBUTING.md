# Contributing to yoCareer

Thanks for your interest in contributing! yoCareer is built with Claude Code, and you can use it for development too.
...
- Report bugs via [Issues](https://github.com/ZCDeng/yoCareer/issues)
...
- **PRs that enable auto-submitting applications** without human review. yoCareer is a decision-support tool, not a spam bot.
...
The "yoCareer" name itself is governed by [TRADEMARK.md](TRADEMARK.md).
...
- [Open an issue](https://github.com/ZCDeng/yoCareer/issues)
